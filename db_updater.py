...
def update_player_database(max_players=None, season='2025-26'):
    """
    ...
    if max_players:
        ...
        first_log = playergamelog.PlayerGameLog(first_player['id'])
    ...
    for player in active_roster[1:]:
        ...
        try:
            log = playergamelog.PlayerGameLog(player_id, season=season)
...
def update_single_player(player_name,season='2025-26'):
    """
